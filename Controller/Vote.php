...
class Vote {
	...
	private function check_ticket($step , $password){
		
		# code...
	}


	private function submit_ticket($step , $password , $c_id_selected){
		
		# code...
	}


	private function close_ticket($step , $password , $c_id_selecte){
